...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      alert('Please enter a prompt and a generate photo');
    }
  }
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          Create imaginative and visually stunning images generated through the AI and share them with the WORLD.
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <div className='relative bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            {form.photo ? (
              ...
              : (
                <img src={preview} alt='preview' className='w-9/2 h-9/2 object-contain opacity-40' />
              )}
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Have you created the image you want? You can share it with your friends, family and community.</p>
